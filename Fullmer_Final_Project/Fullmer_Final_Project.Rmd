...
ggplot(FentandOpiateOverall,aes(x=substance_count,fill=Substance))+geom_bar()+ylab(label ="Overdoses")+xlab(label="Number of Substances")+labs(title = "Occurance of Fentinyl in drug related deaths ")+facet_wrap(~year.x.x)+theme_minimal()
